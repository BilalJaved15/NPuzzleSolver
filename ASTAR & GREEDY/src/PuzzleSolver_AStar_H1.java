...
public class PuzzleSolver_AStar_H1 {
    ...
    PuzzleSolver_AStar_H1(PuzzleState initialState) throws Exception {
        ...
        try {
            ...
            do {
                ...
                if (PuzzleState.isEqual(finalState1, state)) {
                    return ("ASTAR_H1_FINALSTATE1_PATH: " + state.getPath() + "\nASTAR_H1_FINALSTATE1_COST: "
                            + state.getGOfN());
                }
                expanded.add(state);
            ...
            System.out.println("ASTAR_H1_FINALSTATE1_PATH: Solution not found.");
            try {
                ...
                do {
                    ...
                    if (PuzzleState.isEqual(finalState2, state)) {
                        return ("ASTAR_H1_FINALSTATE2_PATH: " + state.getPath() + "\nASTAR_H1_FINALSTATE2_COST: "
                                + state.getGOfN());
                    }
                    expanded.add(state);
                    ArrayList<PuzzleState> transferredStates = new ArrayList<>();
                ...
                return "ASTAR_H1_FINALSTATE2_PATH: Solution not found.";
            }
        }
