...
public class PuzzleSolver_Greedy_H2 {
    ...
    PuzzleSolver_Greedy_H2(PuzzleState initialState) throws Exception {
        ...
        try {
            ...
            do {
                ...
                if (PuzzleState.isEqual(finalState1, state)) {
                    return ("GREEDY_H2_FINALSTATE1_PATH: " + state.getPath() + "\nGREEDY_H2_FINALSTATE1_COST: "
                            + state.getGOfN());
                }
                expanded.add(state);
            ...
            System.out.println("GREEDY_H2_FINALSTATE1_PATH: Solution not found.");
            try {
                ...
                do {
                    ...
                    if (PuzzleState.isEqual(finalState2, state)) {
                        return ("GREEDY_H2_FINALSTATE2_PATH: " + state.getPath() + "\nGREEDY_H2_FINALSTATE2_COST: "
                                + state.getGOfN());
                    }
                    expanded.add(state);
                    ArrayList<PuzzleState> transferredStates = new ArrayList<>();
                ...
                return "GREEDY_H2_FINALSTATE2_PATH: Solution not found.";
            }
        }
