...
public class PuzzleSolver_DFS {
    ...
    PuzzleSolver_DFS(PuzzleState initialState) throws Exception {
            ...
            do {
                ...
                for (int i = 0; i < transferredStates.size(); i++) {
                    if (PuzzleState.isEqual(transferredStates.get(i), finalState1) ||
                        ...
                        return "DFS: " + transferredStates.get(i).getPath();
                    }
                }
            } while (agenda.isEmpty() != true);
        } catch (OutOfMemoryError e) {
            return "DFS: Solution not found.";
        }
        return "DFS: Solution not found.";
    }
